              ...
              <div className="flex justify-start border-t absolute top-30 items-start m-8 pt-8 z-10 gap-8">
                ...
                <div className="relative px-0 md:px-8">
                  <motion.div
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="text-white text-md md:text-sm lg:text-base mb-4 md:h-fit pb-10 flex flex-col items-start gap-4 overflow-auto dark:text-neutral-300 [mask:linear-gradient(to_bottom,white,white,transparent)] [scrollbar-width:none] [-ms-overflow-style:none] [-webkit-overflow-scrolling:touch]"
                  >
