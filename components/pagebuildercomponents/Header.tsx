...
export default function Header({
  ...
  return (
    <section
      className={cn(
        `bg-black grid grid-cols-1 grid-rows-1 text-white h-[50vh] min-h-[500px] overflow-hidden items-center justify-center selection:bg-red-500 selection:text-white`,
        className
      )}
