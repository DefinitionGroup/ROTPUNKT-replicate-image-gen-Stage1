      ...
      <div className="relative w-full aspect-[16/9] sm:aspect-[2.2/1] rounded-xl overflow-hidden ring-1 ring-border/50 bg-black">
        ...
        <div className="absolute inset-x-0 bottom-0 px-4 pb-3">
          <AnimatePresence mode="wait">
            ...
            >
              <span className="text-5xl sm:text-6xl md:text-9xl font-thin text-white tabular-nums tracking-tight">
                {displayStop ? formatTime(displayStop.hour) : "--:--"}
              </span>
              <span className="block text-sm sm:text-sm font-bold uppercase tracking-[0.3em] text-white/90 mt-0.5">
